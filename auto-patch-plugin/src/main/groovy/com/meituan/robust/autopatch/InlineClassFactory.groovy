...
class InlineClassFactory {
    ...
    def dealInLineClass(String patchPath) {
        ...
        for (String fullClassName : inLineClassNameSet) {
            ...
            CtClass inlinePatchClass = PatchesFactory.createPatch(patchPath, inlineClass, true,
                    NameManger.getInstance().getInlinePatchName(inlineClass.name), inlineMethod.toSet())
