        ...
        for (PatchedClassInfo patchedClassInfo : patchedClasses) {
            ...
            try {
                ...
                if (changeQuickRedirectField == null) {
                    robustCallBack.logNotify("changeQuickRedirectField  is null, patch info:"
                            + "id = " + patch.getName()
                            + ",md5 = " + patch.getMd5(),
                ...
                try {
                    ...
                    Log.i("robust", "changeQuickRedirectField set success " + patchClassName);
                } catch (Throwable t) {
